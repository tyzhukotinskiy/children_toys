<section id="main_content">
    <div class="container">
        <div class="crumbs">
            <p><a href="/children_toys/main">Главная страница</a> / Фильтр товаров</p>
        </div>
        <div class="row">
            <div class="col-12">
                <h3>По фильтру: минимальная цена: "<?=$_REQUEST['price_min_filter']?>"; максимальная цена: "<?=$_REQUEST['price_max_filter']?>" было найдено <?php echo count($products); if(count($products) == 1) echo " товар"; else if (count($products) <= 4) echo " товара"; else echo " товаров"?></h3>
                <div class="products">
                    <div class="row">
